...
I'm heading to the field now to complete interviews. We need to identify the vehicle.`,
      kioskSummary: "An outbreak of acute GI illness hit overnight after a church supper in Oswego County. Of ~80 attendees, over 40 fell ill with nausea, vomiting, and diarrhea. No fevers. Identify the vehicle.",
    },
...
Your mission: Determine if the vaccine is causing these cases and identify the scope of the problem.`,
      kioskSummary: "Children across California are developing paralytic polio within days of receiving the new Salk vaccine from one manufacturer. Determine if this is coincidence or causation.",
    },
...
Town features: small downtown area, mix of city water and private wells, several restaurants, a school, and the usual small-town gathering places.`,
      kioskSummary: "A small town in Michigan is seeing a sudden surge of jaundice cases. Patients are turning yellow — is it the water, the food, or something else entirely?",
    },
