...
You are on-call to participate. Review Salmonellosis prior to the briefing.`,
      kioskSummary: "A massive Salmonella outbreak is spreading across multiple states. Standard food history questionnaires are coming up empty. The source is hiding in the supply chain.",
    },
...
Immediate priorities: Define scope, identify exposed patients, develop treatment guidance.`,
      kioskSummary: "Patients who received epidural steroid injections are developing fungal meningitis. The contamination traces back to a single compounding pharmacy in Massachusetts.",
    },
...
CRITICAL QUESTION: How did the travel history get missed? How do we prevent secondary transmission?`,
      kioskSummary: "A man who recently traveled from Liberia presents to a Dallas ER with fever and abdominal pain. He is sent home. Two days later, he returns critically ill. This is the first Ebola case diagnosed in the US.",
    },
...
Request: CDC assistance with specimen testing and field investigation.`,
      kioskSummary: "Doctors on the tiny Pacific island of Yap are seeing a wave of rash, joint pain, and conjunctivitis. It looks like dengue — but the tests say otherwise.",
    },
