...
Two case-control studies are being planned immediately.`,
      kioskSummary: "Young, previously healthy women are arriving at ERs in septic shock. The cases are scattered across multiple states with no obvious common exposure. Find the link.",
    },
...
Many residents are convinced the cooling towers are responsible. We need field investigation support and laboratory assistance.`,
      kioskSummary: "Workers at a paper mill in a rural Louisiana parish are developing severe pneumonia at alarming rates. The source of Legionella is not the usual suspect.",
    },
...
CDC is coordinating a nationwide investigation with FDA.`,
      kioskSummary: "A bizarre new syndrome is appearing — severe muscle pain, sky-high eosinophil counts, and skin changes. Cases are popping up nationwide with no clear connection.",
    },
